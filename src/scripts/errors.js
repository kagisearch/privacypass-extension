...
export const NO_COOKIE_JAR_ACCESS = "<strong>Token generation failed</strong><br/>Are you using the Tor Browser? If so, load your <a href=\"https://help.kagi.com/kagi/privacy/private-browser-sessions.html\" target=\"_blank\">Session Link</a> in the extension's settings menu. Then click \"Generate tokens\" to proceed.";

// the extension UI sends an unrecognized command to the background service worker
export const UI_COMMAND_NOT_RECOGNIZED_ERROR = "<strong>Command not recognized</strong><br/>This error should not have happened. Please contact <a href=\"mailto:support@kagi.com\">support@kagi.com</a> with the steps to reproduce it. Thank you for your help.";
...
export const UNEXPECTED_ERROR_FMT = "<strong>An unexpected error happened</strong><br/>Please contact <a href=\"mailto:support@kagi.com\">support@kagi.com</a> with the error code - {ERROR} - and if possible, the steps to reproduce it. Thank you for your help."
